...
function defaultSettings() {
  ...
  return {
    ...
    useFullScreenPipMaterialFile: false,
    fullScreenPipKeywords: '',
    fullScreenPipDurationSeconds: 4,
    fullScreenPipCloseAtClauseEnd: true,
    fullScreenPipHorizontalAspectMode: '4_3',
    fullScreenPipPriority: 5,
    patentFile: '',
    patentPriority: 5,
    inheritanceFile: '',
